    ...
    <div className=' bg-black text-white'>
      ...
      >
        ...
        <div className="mb-4">
          ...
          <input type="text" className="w-full" id="name"  required ='name'/>
        ...
        <div className="mb-4">
          ...
          <input
            type="email" required = 'Please enter email' className="w-full" id="email"
          ></input>
        ...
        <div className="mb-4">
          ...
          />
              ...
              <div className="text-red-500 ">Password do not match</div></div>
